                    ...
                    <div v-if="finish" class="mb-4 dark:prose-invert dark:prose-headings:text-gray-300"
                        ...
                        <div class="text-center mx-auto"
                             style="width: 90%; height: auto;
                                    border-radius: 30px; background: rgba(3, 7, 18, 1);
                            ...
                            <div style="display: grid;
                                ...
                                <div class="text-left" style="grid-area: 1 / 3 / 2 / 4;
                                    ...
                                    <span>旧棠</span> <br/>
                                    <a class="underline-offset-4 hover:underline"
                                       href="https://github.com/Nights-Guardian-Workshop/Rescue-Me"
                                       rel="noopener noreferrer"
                                       target="_blank">Rescue-Me</a>
                                </div>
                                <div style="grid-area: 2 / 1 / 3 / 4;
                                    ...
                                    <div class="text-center"
                                         style="grid-area: 2 / 1 / 3 / 4; display: flex; align-items: center; justify-content: center;">
